...
class VQVAE(utils.GM):
    ...
    def train_step(self, x):
        ...
        return {'vq_vae_loss': loss, 'recon_loss': recon_loss, 'embed_loss': embed_loss, 'perplexity': perplexity,
...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, z):
        ...
        d = th.sum(z_flattened ** 2, dim=1, keepdim=True) + th.sum(self.embedding.weight ** 2, dim=1) - 2 * th.matmul(
